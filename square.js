 ...
 */
class SquareShader extends ShaderProgram {
    ...
    loadShader() {
        ...
        let circleShader = getShaderProgramAsync(gl, "square");
        let shaderObj = this;
        circleShader.then(function(shader) {
            ...
            shader.uHalfSideLenUniform = gl.getUniformLocation(shader, "uHalfSideLen");
    ...
    render() {
        ...
        gl.uniform1f(shader.uHalfSideLenUniform, this.halfSideLen);
